...
<header class="header">
	<a class="avatar" href="https://vallek.github.io/index.html" aria-label="Ссылка на портфолио разработчика" title="Ссылка на портфолио разработчика">
		<img class="avatar__image" src="/ava.jpg" alt="аватарка с фото автора" width="40" height="40">
	</a>
	...
	<section class="header__social-links">
		<a class="header__social-link header__social-link_tg" href="https://t.me/webval" title="Связаться через телеграм" aria-label="Связаться через телеграм">
			<img class="header__social-logo" width="25" height="25" src="/tg.svg" alt="">
		</a>
		<a class="header__social-link header__social-link_email" href="mailto:vwebdis@gmail.com" title="Связаться по почте" aria-label="Связаться по почте">
			<img class="header__social-logo" width="25" height="25" src="/email.png" alt="">
		</a>
	</section>
</header>
<main>
			...
			<div class="works__list">
				<a class="works__link" href="https://chromchemlab.ru/">
					<section class="works__item">
						...
						<img class="works__img" width="305" height="372" src="https://vallek.github.io//works/chromchemlab.webp" alt="Скриншот работы" loading="lazy">
					</section>
				</a>
				<a class="works__link" href="https://machrome.ru/">
					<section class="works__item">
						<div class="works__backdrop"><h3 class="works__title">Сайт Машхром<br></h3></div>
						<img class="works__img" width="305" height="372" src="/machrome.jpg" alt="Скриншот работы" loading="lazy">
					</section>
				</a>
				<a class="works__link" href="https://massspec.ru/">
					<section class="works__item">
						<div class="works__backdrop"><h3 class="works__title">Сайт НИЦ АкваХром</h3></div>
						<img class="works__img" width="305" height="372" src="/massspec.webp" alt="Скриншот работы" loading="lazy">
					</section>
				</a>
				<a class="works__link" href="https://vallek.github.io/activica-test/">
					<section class="works__item">
						...
						<img class="works__img" width="305" height="372" src="/activica.jpg" alt="Скриншот работы" loading="lazy">
					</section>
				</a>
				<a class="works__link" href="https://vallek.github.io/magwai-test/">
					<section class="works__item">
						...
						<img class="works__img" width="305" height="372" src="/magwai.jpg" alt="Скриншот работы" loading="lazy">
					</section>
				</a>
				<a class="works__link" href="https://vallek.github.io/yc-chess-landing/">
					<section class="works__item">
						...
						<img class="works__img" width="305" height="372" src="/yc-chess.jpg" alt="Скриншот работы" loading="lazy">
					</section>
				</a>
			</div>
		</div>
	...
	<section class="about-us">
		<div class="about-us__content">
			...
			<div class="about-us__photo">
				<img width="600" height="300" class="about-us__img" src="/dev-ava.jpg" alt="Фото разработчика" loading="lazy">
			</div>
		</div>
	</section>
