(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))c(s);new MutationObserver(s=>{for(const e of s)if(e.type==="childList")for(const t of e.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&c(t)}).observe(document,{childList:!0,subtree:!0});function l(s){const e={};return s.integrity&&(e.integrity=s.integrity),s.referrerPolicy&&(e.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?e.credentials="include":s.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function c(s){if(s.ep)return;s.ep=!0;const e=l(s);fetch(s.href,e)}})();function _(){const a=document.querySelector(".page__intro"),i=document.querySelector(".header"),l=window.innerHeight,c=i.getBoundingClientRect().bottom;function s(){let e=a.getBoundingClientRect().top;e<=l-c&&e>=0?(a.classList.remove("scroll-up"),a.classList.add("scroll-down")):e<0&&(a.classList.remove("scroll-down"),a.classList.add("scroll-up"))}window.matchMedia("(prefers-reduced-motion: reduce)").matches||window.addEventListener("scroll",s)}function n(){const a=document.querySelector(".sites__item_pop"),i=document.querySelector(".sites__item_left"),l=document.querySelector(".sites__item_right"),c=[i,l],s=window.innerHeight,e=250;c.forEach(t=>{function o(){a.getBoundingClientRect().top<s-e&&(t.classList.add("slide-out"),setTimeout(()=>{t.classList.remove("slide-slow")},100))}window.addEventListener("scroll",o),o()})}function r(){const a=document.querySelector(".page"),i=document.querySelector(".header"),l=i.querySelector(".popup-menu__input"),c=i.querySelectorAll(".popup-menu__link"),s=i.querySelector(".header__item:first-child");function e(){a.getBoundingClientRect().top<-600?(i.classList.add("header__menu_anim"),s.classList.remove("visually-hidden")):(i.classList.remove("header__menu_anim"),s.classList.add("visually-hidden"))}window.addEventListener("scroll",e),window.addEventListener("DOMContentLoaded",e),c.forEach(t=>{t.addEventListener("click",()=>{l.checked=!1})}),document.addEventListener("click",t=>{let o=t.target;i.contains(o)||(l.checked=!1)})}document.querySelector("#app").innerHTML=`
<header class="header">
...
`;_(document.querySelector("#app"));n(document.querySelector("#app"));r(document.querySelector("#app"));
